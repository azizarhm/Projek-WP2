...
?>
<!-- Header -->
    <div class="header pb-6" style="background-color: #54586e;">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col-xl-8">
          <div class="card" style="background-color: #7ababb;">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0" style="color: #54586e;">Ringkasan Penjualan</h5> 
                  <p style="text-align: justify;">Walaupun banyaknya order mengalami kemunduran, tetapi pendapatan mengalami kenaikan
                      pada bulan Mei - Agustus 2022. Jika pendapatan terus meningkat, maka akan menutupi 
                      berapa banyak order yang masuk. Namun, alangkah lebih baiknya jika banyaknya order 
                      dengan pendapatan yang masuk, sama-sama meningkat juga. Hal ini akan membuat grafik 
                      pendapatan dan banyaknya order menjadi bagus, karna terus meningkat.
                  </p>
                </div>
              </div>
            </div>
              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>" class="btn btn-sm" style="background-color: #54586e; color:white;">Profile</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('admin/products'); ?>" class="btn btn-sm" style="background-color: #54586e; color:white;">Show all</a>
                </div>
              </div>
            </div>

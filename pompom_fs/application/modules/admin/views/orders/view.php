              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="text-right">
                    <input type="submit" value="OK" class="btn btn-md" style="background-color: #54586e; color:white;">
                  </div>
                </div>
              </div>
            </form>
            ...
            <form action="<?php echo site_url('admin/payments/verify'); ?>" method="POST">
              <div class="row">
                ...
                <div class="col-md-3 text-right">
                  <input type="submit" class="btn" value="OK" style="background-color: #54586e; color:white;">
                </div>
              </div>
            </form>
          </div>

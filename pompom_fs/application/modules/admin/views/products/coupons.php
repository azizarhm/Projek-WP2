        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" data-target="#addModal" data-toggle="modal" class="btn btn-neutral" style="color: #54586e;">Tambah</a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" id="addCouponForm">
                          ...
                          <div class="float-right" style="margin-top: -90px">
                            <button type="submit" class="btn my-4 addPackageBtn" style="background-color: #54586e; color:white;">Tambah</button>
                        </div>
                      </form>
                  </div>
              </div>
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" id="editCouponForm">
                        ...
                        <div class="form-group mb-3">
                          ...
                          <div class="float-right" style="margin-top: -90px">
                            <button type="submit" class="btn my-4 editPackageBtn" style="background-color: #54586e; color:white;">Simpan</button>
                        </div>
                      </form>
                  </div>
              </div>

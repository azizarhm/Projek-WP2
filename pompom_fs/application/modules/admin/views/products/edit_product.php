        ...
        <div class="col-md-4">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <ul class="nav nav-pills mb-3 float-right" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link p-1 active" id="pills-current-tab" data-toggle="pill" href="#pills-current" role="tab" aria-controls="pills-home" aria-selected="true" style="background-color: #54586e;">Current</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-1" id="pills-edit-tab" data-toggle="pill" href="#pills-edit" role="tab" aria-controls="pills-profile" aria-selected="false" style="color: #54586e;">Ganti</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-1" id="pills-delete-tab" data-toggle="pill" href="#pills-delete" role="tab" aria-controls="pills-contact" aria-selected="false" style="color: #54586e;">Hapus</a>
                                </li>
                            </ul>
                        </div>
                        <?php endif; ?>
                ...
                <div class="card-footer text-right">
                    <input type="submit" value="Simpan" class="btn" style="background-color: #54586e; color:white;">
                </div>
            </div>
        </div>
      </div>

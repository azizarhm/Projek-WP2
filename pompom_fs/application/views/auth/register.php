...
<body>
    <div class="page-wrapper p-t-180 p-b-100 font-robo" style="background-color: #871a1a;">
            ...
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('auth/register/verify'); ?>
                        ...
                        <div class="p-t-30">
                            <button class="btn btn--radius" style="background-color: #871a1a;" type="submit">Daftar</button>
                        </div>
                    </form>
                </div>
            </div>

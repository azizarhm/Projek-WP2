      ...
      <div class="row justify-content-center">
        ...
        <div class="col-xl-5">
            <div class="row mt-5 pt-3">
                    ...
                    <div class="cart-detail cart-total p-3 p-md-4">
                        ...
                        <p class="d-flex">
                              ...
                              <p class="d-flex total-price">
                                  <span>Total</span>
                                  <span class="n-total font-weight-bold" style="color: #871a1a;">Rp <?php echo format_rupiah($total); ?></span>
                              </p>
                              </div>
                </div>
                <div class="col-md-12">
                ...
                <input type="submit" class="btn py-2 px-2" style="background-color: #871a1a; color:white;" value="Buat Pesanan">
            </div>
                </div>

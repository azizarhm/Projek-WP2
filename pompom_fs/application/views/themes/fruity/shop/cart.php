                  ...
                  <div class="cart-list">
                      <table class="table">
                          <thead class="thead-primary">
                            <tr class="text-center" style="background-color: #871a1a;">
                              <th>&nbsp;</th>
                              <th>&nbsp;</th>
                              <th>Produk</th>
                              <th>Harga</th>
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      ...
                      <p class="d-flex total-price">
                          <span>Total</span>
                          <span class="n-total font-weight-bold" style="color: #871a1a;">Rp <?php echo format_rupiah($total_price); ?></span>
                      </p>
                  </div>
                  <p><button type="submit" class="btn py-3 px-4" style="background-color: #871a1a; color:white;">Checkout</button></p>
              </div>
          </div>
          </form>
          <?php else : ?>

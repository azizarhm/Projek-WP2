              ...
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                  ...
                  <p class="price">
                      <?php if ($product->current_discount > 0) : ?>
                        ...
                        <span class="price-sale" style="color: #871a1a;">Rp <?php echo format_rupiah($product->price - $product->current_discount); ?></span>
                      <?php else : ?>
  ...
  <section class="ftco-section">
      <div class="container">
        ...
        <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading" style="color: #871a1a;"><b>Produk Lain</b></span>
              ...
              <div class="col-md-6 col-lg-3 ftco-animate">
                  <div class="product">
                      <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo base_url('assets/uploads/products/'. $product->picture_name); ?>" alt="<?php echo $product->name; ?>">
                          <?php if ($product->current_discount > 0) : ?>
                          <span style="background-color: #871a1a;" class="status"><?php echo count_percent_discount($product->current_discount, $product->price); ?>%</span>
                          <?php endif; ?>
